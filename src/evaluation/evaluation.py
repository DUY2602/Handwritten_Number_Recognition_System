...
# ================================================================
# EVALUATION 2 — PyTorch / character model trên output_digit
# ================================================================
...
def evaluate_pytorch_model(
    ...
    """
    Đánh giá model ký tự trên các ROI trong output_digit/.
...
def segmentation_length_status(true_len: int, pred_len: int) -> Tuple[str, Optional[str]]:
    ...
    if pred_len < true_len:
        return "UNDER_SEGMENT", "Thiếu ký tự (ký tự bị dính nhau hoặc mất nét)"
    return "OVER_SEGMENT", "Dư ký tự (noise, box vỡ, hoặc tách quá mức)"
...
def evaluate_segmentation_debug(
    ...
    """
    Đo lỗi segmentation ở mức cơ bản:
    - số lượng box đúng hay không
    - rects đang ra bao nhiêu box
    - status là OK / UNDER / OVER
    """
...
def visualize_segmentation(
    ...
    """
    Vẽ bounding box + index để nhìn thẳng segmentation đang cắt ra gì.
    """
...
def evaluate_full_pipeline_debug(
    ...
    """
    Chạy 1 ảnh duy nhất và trả về dict debug đầy đủ:
    - segmentation status
    - predicted chars
    - predicted expr
    """
